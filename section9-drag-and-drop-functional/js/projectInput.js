...
export default function ProjectInput() {
    ...
    form.id = "user-input";
    configure();
    let titleInputELement = form.querySelector("#title");
    let descriptionInputELement = form.querySelector("#description");
    let numberInputELement = form.querySelector("#people");
    function configure() {
    ...
    function handleSubmitting(e) {
        ...
        if (validate({
            ...
            gatherUserInputs(titleInputELement.value, descriptionInputELement.value, +numberInputELement.value);
    ...
    function gatherUserInputs(str1, str2, num) {
